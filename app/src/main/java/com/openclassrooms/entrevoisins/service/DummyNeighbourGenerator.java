...
public abstract class DummyNeighbourGenerator {
    ...
    public static List<Neighbour> DUMMY_NEIGHBOURS = Arrays.asList(
            ...
            /*
            /// EASTEREGG ///
            new Neighbour(13, "Mathieu", "https://i.ibb.co/tC9Rd25/150.jpg", "10 Quai de la Charente, 75019 PARIS",
                    "+33 1 80 88 80 30",  "Make education accessible (Rendre l'éducation accessible).")
            */
    );
